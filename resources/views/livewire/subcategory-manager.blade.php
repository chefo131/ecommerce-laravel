<div>
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                        ...
                                        <a href="#" wire:click.prevent="confirmDelete({{ $subcategory->id }})"
                                            class="ml-4 text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">Eliminar</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <x-dialog-modal wire:model.live="showDeleteModal">
        ...
        <x-slot name="content">
            ¿Estás seguro de que quieres eliminar la subcategoría "<strong>{{ $deletingSubcategory?->name }}</strong>"?
        ...
        <x-slot name="footer">
            ...
            <x-danger-button class="ml-2" wire:click="deleteSubcategory" wire:loading.attr="disabled">
                Eliminar Subcategoría
            </x-danger-button>
        </x-slot>
    </x-dialog-modal>
